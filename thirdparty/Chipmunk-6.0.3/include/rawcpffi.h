...
typedef uintptr_t cpHashValue;
 ...
 typedef struct cpVect{cpFloat x,y;
} cpVect;
...
static inline cpVect cpBodyGetVel(const cpBody *body){return body->v;
} static inline void cpBodySetVel(cpBody *body, const cpVect value){ cpBodyActivate(body);
 cpBodySanityCheck(body);
 body->v = value;
 };
static inline cpVect cpBodyGetForce(const cpBody *body){return body->f;
} static inline void cpBodySetForce(cpBody *body, const cpVect value){ cpBodyActivate(body);
 cpBodySanityCheck(body);
 body->f = value;
 };
...
static inline cpFloat cpBodyGetAngVel(const cpBody *body){return body->w;
} static inline void cpBodySetAngVel(cpBody *body, const cpFloat value){ cpBodyActivate(body);
 cpBodySanityCheck(body);
 body->w = value;
 };
static inline cpFloat cpBodyGetTorque(const cpBody *body){return body->t;
} static inline void cpBodySetTorque(cpBody *body, const cpFloat value){ cpBodyActivate(body);
 cpBodySanityCheck(body);
 body->t = value;
 };
static inline cpVect cpBodyGetRot(const cpBody *body){return body->rot;
};
static inline cpFloat cpBodyGetVelLimit(const cpBody *body){return body->v_limit;
} static inline void cpBodySetVelLimit(cpBody *body, const cpFloat value){ cpBodyActivate(body);
 cpBodySanityCheck(body);
 body->v_limit = value;
 };
static inline cpFloat cpBodyGetAngVelLimit(const cpBody *body){return body->w_limit;
} static inline void cpBodySetAngVelLimit(cpBody *body, const cpFloat value){ cpBodyActivate(body);
 cpBodySanityCheck(body);
 body->w_limit = value;
 };
static inline cpDataPointer cpBodyGetUserData(const cpBody *body){return body->data;
} static inline void cpBodySetUserData(cpBody *body, const cpDataPointer value){ cpBodyActivate(body);
 cpBodySanityCheck(body);
 body->data = value;
 };
...
static inline cpBool cpShapeGetSensor(const cpShape *shape){return shape->sensor;
} static inline void cpShapeSetSensor(cpShape *shape, cpBool value){ if(1 && shape->body) cpBodyActivate(shape->body);
 shape->sensor = value;
 };
static inline cpFloat cpShapeGetElasticity(const cpShape *shape){return shape->e;
} static inline void cpShapeSetElasticity(cpShape *shape, cpFloat value){ if(0 && shape->body) cpBodyActivate(shape->body);
 shape->e = value;
 };
static inline cpFloat cpShapeGetFriction(const cpShape *shape){return shape->u;
} static inline void cpShapeSetFriction(cpShape *shape, cpFloat value){ if(1 && shape->body) cpBodyActivate(shape->body);
 shape->u = value;
 };
static inline cpVect cpShapeGetSurfaceVelocity(const cpShape *shape){return shape->surface_v;
} static inline void cpShapeSetSurfaceVelocity(cpShape *shape, cpVect value){ if(1 && shape->body) cpBodyActivate(shape->body);
 shape->surface_v = value;
 };
static inline cpDataPointer cpShapeGetUserData(const cpShape *shape){return shape->data;
} static inline void cpShapeSetUserData(cpShape *shape, cpDataPointer value){ if(0 && shape->body) cpBodyActivate(shape->body);
 shape->data = value;
 };
static inline cpCollisionType cpShapeGetCollisionType(const cpShape *shape){return shape->collision_type;
} static inline void cpShapeSetCollisionType(cpShape *shape, cpCollisionType value){ if(1 && shape->body) cpBodyActivate(shape->body);
 shape->collision_type = value;
 };
static inline cpGroup cpShapeGetGroup(const cpShape *shape){return shape->group;
} static inline void cpShapeSetGroup(cpShape *shape, cpGroup value){ if(1 && shape->body) cpBodyActivate(shape->body);
 shape->group = value;
 };
static inline cpLayers cpShapeGetLayers(const cpShape *shape){return shape->layers;
} static inline void cpShapeSetLayers(cpShape *shape, cpLayers value){ if(1 && shape->body) cpBodyActivate(shape->body);
 shape->layers = value;
 };
...
static inline cpFloat cpArbiterGetElasticity(const cpArbiter *arb){return arb->e;
} static inline void cpArbiterSetElasticity(cpArbiter *arb, cpFloat value){arb->e = value;
};
static inline cpFloat cpArbiterGetFriction(const cpArbiter *arb){return arb->u;
} static inline void cpArbiterSetFriction(cpArbiter *arb, cpFloat value){arb->u = value;
};
static inline cpVect cpArbiterGetSurfaceVelocity(const cpArbiter *arb){return arb->surface_vr;
} static inline void cpArbiterSetSurfaceVelocity(cpArbiter *arb, cpVect value){arb->surface_vr = value;
};
...
static inline cpFloat cpConstraintGetMaxForce(const cpConstraint *constraint){return constraint->maxForce;
} static inline void cpConstraintSetMaxForce(cpConstraint *constraint, cpFloat value){ cpConstraintActivateBodies(constraint);
 constraint->maxForce = value;
 };
static inline cpFloat cpConstraintGetErrorBias(const cpConstraint *constraint){return constraint->errorBias;
} static inline void cpConstraintSetErrorBias(cpConstraint *constraint, cpFloat value){ cpConstraintActivateBodies(constraint);
 constraint->errorBias = value;
 };
static inline cpFloat cpConstraintGetMaxBias(const cpConstraint *constraint){return constraint->maxBias;
} static inline void cpConstraintSetMaxBias(cpConstraint *constraint, cpFloat value){ cpConstraintActivateBodies(constraint);
 constraint->maxBias = value;
 };
static inline cpConstraintPreSolveFunc cpConstraintGetPreSolveFunc(const cpConstraint *constraint){return constraint->preSolve;
} static inline void cpConstraintSetPreSolveFunc(cpConstraint *constraint, cpConstraintPreSolveFunc value){ cpConstraintActivateBodies(constraint);
 constraint->preSolve = value;
 };
static inline cpConstraintPostSolveFunc cpConstraintGetPostSolveFunc(const cpConstraint *constraint){return constraint->postSolve;
} static inline void cpConstraintSetPostSolveFunc(cpConstraint *constraint, cpConstraintPostSolveFunc value){ cpConstraintActivateBodies(constraint);
 constraint->postSolve = value;
 };
static inline cpDataPointer cpConstraintGetUserData(const cpConstraint *constraint){return constraint->data;
} static inline void cpConstraintSetUserData(cpConstraint *constraint, cpDataPointer value){ cpConstraintActivateBodies(constraint);
...
static inline cpVect cpPinJointGetAnchr1(const cpConstraint *constraint){ if(!(constraint->klass_private == cpPinJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPinJointGetClass()", "chipmunk/constraints/cpPinJoint.h", 48, 1, 1, "Constraint is not a ""cpPinJoint");
 return ((cpPinJoint *)constraint)->anchr1;
 } static inline void cpPinJointSetAnchr1(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpPinJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPinJointGetClass()", "chipmunk/constraints/cpPinJoint.h", 48, 1, 1, "Constraint is not a ""cpPinJoint");
 cpConstraintActivateBodies(constraint);
 ((cpPinJoint *)constraint)->anchr1 = value;
 };
static inline cpVect cpPinJointGetAnchr2(const cpConstraint *constraint){ if(!(constraint->klass_private == cpPinJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPinJointGetClass()", "chipmunk/constraints/cpPinJoint.h", 49, 1, 1, "Constraint is not a ""cpPinJoint");
 return ((cpPinJoint *)constraint)->anchr2;
 } static inline void cpPinJointSetAnchr2(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpPinJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPinJointGetClass()", "chipmunk/constraints/cpPinJoint.h", 49, 1, 1, "Constraint is not a ""cpPinJoint");
 cpConstraintActivateBodies(constraint);
 ((cpPinJoint *)constraint)->anchr2 = value;
 };
static inline cpFloat cpPinJointGetDist(const cpConstraint *constraint){ if(!(constraint->klass_private == cpPinJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPinJointGetClass()", "chipmunk/constraints/cpPinJoint.h", 50, 1, 1, "Constraint is not a ""cpPinJoint");
 return ((cpPinJoint *)constraint)->dist;
 } static inline void cpPinJointSetDist(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpPinJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPinJointGetClass()", "chipmunk/constraints/cpPinJoint.h", 50, 1, 1, "Constraint is not a ""cpPinJoint");
 cpConstraintActivateBodies(constraint);
 ((cpPinJoint *)constraint)->dist = value;
 };
...
static inline cpVect cpSlideJointGetAnchr1(const cpConstraint *constraint){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 48, 1, 1, "Constraint is not a ""cpSlideJoint");
 return ((cpSlideJoint *)constraint)->anchr1;
 } static inline void cpSlideJointSetAnchr1(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 48, 1, 1, "Constraint is not a ""cpSlideJoint");
 cpConstraintActivateBodies(constraint);
 ((cpSlideJoint *)constraint)->anchr1 = value;
 };
static inline cpVect cpSlideJointGetAnchr2(const cpConstraint *constraint){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 49, 1, 1, "Constraint is not a ""cpSlideJoint");
 return ((cpSlideJoint *)constraint)->anchr2;
 } static inline void cpSlideJointSetAnchr2(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 49, 1, 1, "Constraint is not a ""cpSlideJoint");
 cpConstraintActivateBodies(constraint);
 ((cpSlideJoint *)constraint)->anchr2 = value;
 };
static inline cpFloat cpSlideJointGetMin(const cpConstraint *constraint){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 50, 1, 1, "Constraint is not a ""cpSlideJoint");
 return ((cpSlideJoint *)constraint)->min;
 } static inline void cpSlideJointSetMin(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 50, 1, 1, "Constraint is not a ""cpSlideJoint");
 cpConstraintActivateBodies(constraint);
 ((cpSlideJoint *)constraint)->min = value;
 };
static inline cpFloat cpSlideJointGetMax(const cpConstraint *constraint){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 51, 1, 1, "Constraint is not a ""cpSlideJoint");
 return ((cpSlideJoint *)constraint)->max;
 } static inline void cpSlideJointSetMax(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpSlideJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSlideJointGetClass()", "chipmunk/constraints/cpSlideJoint.h", 51, 1, 1, "Constraint is not a ""cpSlideJoint");
 cpConstraintActivateBodies(constraint);
 ((cpSlideJoint *)constraint)->max = value;
 };
...
static inline cpVect cpPivotJointGetAnchr1(const cpConstraint *constraint){ if(!(constraint->klass_private == cpPivotJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPivotJointGetClass()", "chipmunk/constraints/cpPivotJoint.h", 49, 1, 1, "Constraint is not a ""cpPivotJoint");
 return ((cpPivotJoint *)constraint)->anchr1;
 } static inline void cpPivotJointSetAnchr1(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpPivotJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPivotJointGetClass()", "chipmunk/constraints/cpPivotJoint.h", 49, 1, 1, "Constraint is not a ""cpPivotJoint");
 cpConstraintActivateBodies(constraint);
 ((cpPivotJoint *)constraint)->anchr1 = value;
 };
static inline cpVect cpPivotJointGetAnchr2(const cpConstraint *constraint){ if(!(constraint->klass_private == cpPivotJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPivotJointGetClass()", "chipmunk/constraints/cpPivotJoint.h", 50, 1, 1, "Constraint is not a ""cpPivotJoint");
 return ((cpPivotJoint *)constraint)->anchr2;
 } static inline void cpPivotJointSetAnchr2(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpPivotJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpPivotJointGetClass()", "chipmunk/constraints/cpPivotJoint.h", 50, 1, 1, "Constraint is not a ""cpPivotJoint");
 cpConstraintActivateBodies(constraint);
 ((cpPivotJoint *)constraint)->anchr2 = value;
 };
...
static inline cpVect cpGrooveJointGetGrooveA(const cpConstraint *constraint){ if(!(constraint->klass_private == cpGrooveJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpGrooveJointGetClass()", "chipmunk/constraints/cpGrooveJoint.h", 50, 1, 1, "Constraint is not a ""cpGrooveJoint");
 return ((cpGrooveJoint *)constraint)->grv_a;
 };
void cpGrooveJointSetGrooveA(cpConstraint *constraint, cpVect value);
static inline cpVect cpGrooveJointGetGrooveB(const cpConstraint *constraint){ if(!(constraint->klass_private == cpGrooveJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpGrooveJointGetClass()", "chipmunk/constraints/cpGrooveJoint.h", 53, 1, 1, "Constraint is not a ""cpGrooveJoint");
 return ((cpGrooveJoint *)constraint)->grv_b;
 };
void cpGrooveJointSetGrooveB(cpConstraint *constraint, cpVect value);
static inline cpVect cpGrooveJointGetAnchr2(const cpConstraint *constraint){ if(!(constraint->klass_private == cpGrooveJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpGrooveJointGetClass()", "chipmunk/constraints/cpGrooveJoint.h", 56, 1, 1, "Constraint is not a ""cpGrooveJoint");
 return ((cpGrooveJoint *)constraint)->anchr2;
 } static inline void cpGrooveJointSetAnchr2(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpGrooveJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpGrooveJointGetClass()", "chipmunk/constraints/cpGrooveJoint.h", 56, 1, 1, "Constraint is not a ""cpGrooveJoint");
 cpConstraintActivateBodies(constraint);
 ((cpGrooveJoint *)constraint)->anchr2 = value;
 };
...
static inline cpVect cpDampedSpringGetAnchr1(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 55, 1, 1, "Constraint is not a ""cpDampedSpring");
 return ((cpDampedSpring *)constraint)->anchr1;
 } static inline void cpDampedSpringSetAnchr1(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 55, 1, 1, "Constraint is not a ""cpDampedSpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedSpring *)constraint)->anchr1 = value;
 };
static inline cpVect cpDampedSpringGetAnchr2(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 56, 1, 1, "Constraint is not a ""cpDampedSpring");
 return ((cpDampedSpring *)constraint)->anchr2;
 } static inline void cpDampedSpringSetAnchr2(cpConstraint *constraint, cpVect value){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 56, 1, 1, "Constraint is not a ""cpDampedSpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedSpring *)constraint)->anchr2 = value;
 };
static inline cpFloat cpDampedSpringGetRestLength(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 57, 1, 1, "Constraint is not a ""cpDampedSpring");
 return ((cpDampedSpring *)constraint)->restLength;
 } static inline void cpDampedSpringSetRestLength(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 57, 1, 1, "Constraint is not a ""cpDampedSpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedSpring *)constraint)->restLength = value;
 };
static inline cpFloat cpDampedSpringGetStiffness(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 58, 1, 1, "Constraint is not a ""cpDampedSpring");
 return ((cpDampedSpring *)constraint)->stiffness;
 } static inline void cpDampedSpringSetStiffness(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 58, 1, 1, "Constraint is not a ""cpDampedSpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedSpring *)constraint)->stiffness = value;
 };
static inline cpFloat cpDampedSpringGetDamping(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 59, 1, 1, "Constraint is not a ""cpDampedSpring");
 return ((cpDampedSpring *)constraint)->damping;
 } static inline void cpDampedSpringSetDamping(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 59, 1, 1, "Constraint is not a ""cpDampedSpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedSpring *)constraint)->damping = value;
 };
static inline cpDampedSpringForceFunc cpDampedSpringGetSpringForceFunc(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 60, 1, 1, "Constraint is not a ""cpDampedSpring");
 return ((cpDampedSpring *)constraint)->springForceFunc;
 } static inline void cpDampedSpringSetSpringForceFunc(cpConstraint *constraint, cpDampedSpringForceFunc value){ if(!(constraint->klass_private == cpDampedSpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedSpringGetClass()", "chipmunk/constraints/cpDampedSpring.h", 60, 1, 1, "Constraint is not a ""cpDampedSpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedSpring *)constraint)->springForceFunc = value;
 };
...
static inline cpFloat cpDampedRotarySpringGetRestAngle(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 50, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 return ((cpDampedRotarySpring *)constraint)->restAngle;
 } static inline void cpDampedRotarySpringSetRestAngle(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 50, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedRotarySpring *)constraint)->restAngle = value;
 };
static inline cpFloat cpDampedRotarySpringGetStiffness(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 51, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 return ((cpDampedRotarySpring *)constraint)->stiffness;
 } static inline void cpDampedRotarySpringSetStiffness(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 51, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedRotarySpring *)constraint)->stiffness = value;
 };
static inline cpFloat cpDampedRotarySpringGetDamping(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 52, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 return ((cpDampedRotarySpring *)constraint)->damping;
 } static inline void cpDampedRotarySpringSetDamping(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 52, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedRotarySpring *)constraint)->damping = value;
 };
static inline cpDampedRotarySpringTorqueFunc cpDampedRotarySpringGetSpringTorqueFunc(const cpConstraint *constraint){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 53, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 return ((cpDampedRotarySpring *)constraint)->springTorqueFunc;
 } static inline void cpDampedRotarySpringSetSpringTorqueFunc(cpConstraint *constraint, cpDampedRotarySpringTorqueFunc value){ if(!(constraint->klass_private == cpDampedRotarySpringGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpDampedRotarySpringGetClass()", "chipmunk/constraints/cpDampedRotarySpring.h", 53, 1, 1, "Constraint is not a ""cpDampedRotarySpring");
 cpConstraintActivateBodies(constraint);
 ((cpDampedRotarySpring *)constraint)->springTorqueFunc = value;
 };
...
static inline cpFloat cpRotaryLimitJointGetMin(const cpConstraint *constraint){ if(!(constraint->klass_private == cpRotaryLimitJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRotaryLimitJointGetClass()", "chipmunk/constraints/cpRotaryLimitJoint.h", 45, 1, 1, "Constraint is not a ""cpRotaryLimitJoint");
 return ((cpRotaryLimitJoint *)constraint)->min;
 } static inline void cpRotaryLimitJointSetMin(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpRotaryLimitJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRotaryLimitJointGetClass()", "chipmunk/constraints/cpRotaryLimitJoint.h", 45, 1, 1, "Constraint is not a ""cpRotaryLimitJoint");
 cpConstraintActivateBodies(constraint);
 ((cpRotaryLimitJoint *)constraint)->min = value;
 };
static inline cpFloat cpRotaryLimitJointGetMax(const cpConstraint *constraint){ if(!(constraint->klass_private == cpRotaryLimitJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRotaryLimitJointGetClass()", "chipmunk/constraints/cpRotaryLimitJoint.h", 46, 1, 1, "Constraint is not a ""cpRotaryLimitJoint");
 return ((cpRotaryLimitJoint *)constraint)->max;
 } static inline void cpRotaryLimitJointSetMax(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpRotaryLimitJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRotaryLimitJointGetClass()", "chipmunk/constraints/cpRotaryLimitJoint.h", 46, 1, 1, "Constraint is not a ""cpRotaryLimitJoint");
 cpConstraintActivateBodies(constraint);
 ((cpRotaryLimitJoint *)constraint)->max = value;
 };
...
static inline cpFloat cpRatchetJointGetAngle(const cpConstraint *constraint){ if(!(constraint->klass_private == cpRatchetJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRatchetJointGetClass()", "chipmunk/constraints/cpRatchetJoint.h", 45, 1, 1, "Constraint is not a ""cpRatchetJoint");
 return ((cpRatchetJoint *)constraint)->angle;
 } static inline void cpRatchetJointSetAngle(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpRatchetJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRatchetJointGetClass()", "chipmunk/constraints/cpRatchetJoint.h", 45, 1, 1, "Constraint is not a ""cpRatchetJoint");
 cpConstraintActivateBodies(constraint);
 ((cpRatchetJoint *)constraint)->angle = value;
 };
static inline cpFloat cpRatchetJointGetPhase(const cpConstraint *constraint){ if(!(constraint->klass_private == cpRatchetJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRatchetJointGetClass()", "chipmunk/constraints/cpRatchetJoint.h", 46, 1, 1, "Constraint is not a ""cpRatchetJoint");
 return ((cpRatchetJoint *)constraint)->phase;
 } static inline void cpRatchetJointSetPhase(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpRatchetJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRatchetJointGetClass()", "chipmunk/constraints/cpRatchetJoint.h", 46, 1, 1, "Constraint is not a ""cpRatchetJoint");
 cpConstraintActivateBodies(constraint);
 ((cpRatchetJoint *)constraint)->phase = value;
 };
static inline cpFloat cpRatchetJointGetRatchet(const cpConstraint *constraint){ if(!(constraint->klass_private == cpRatchetJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRatchetJointGetClass()", "chipmunk/constraints/cpRatchetJoint.h", 47, 1, 1, "Constraint is not a ""cpRatchetJoint");
 return ((cpRatchetJoint *)constraint)->ratchet;
 } static inline void cpRatchetJointSetRatchet(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpRatchetJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpRatchetJointGetClass()", "chipmunk/constraints/cpRatchetJoint.h", 47, 1, 1, "Constraint is not a ""cpRatchetJoint");
 cpConstraintActivateBodies(constraint);
 ((cpRatchetJoint *)constraint)->ratchet = value;
 };
...
static inline cpFloat cpGearJointGetPhase(const cpConstraint *constraint){ if(!(constraint->klass_private == cpGearJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpGearJointGetClass()", "chipmunk/constraints/cpGearJoint.h", 46, 1, 1, "Constraint is not a ""cpGearJoint");
 return ((cpGearJoint *)constraint)->phase;
 } static inline void cpGearJointSetPhase(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpGearJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpGearJointGetClass()", "chipmunk/constraints/cpGearJoint.h", 46, 1, 1, "Constraint is not a ""cpGearJoint");
 cpConstraintActivateBodies(constraint);
 ((cpGearJoint *)constraint)->phase = value;
 };
static inline cpFloat cpGearJointGetRatio(const cpConstraint *constraint){ if(!(constraint->klass_private == cpGearJointGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpGearJointGetClass()", "chipmunk/constraints/cpGearJoint.h", 47, 1, 1, "Constraint is not a ""cpGearJoint");
...
static inline cpFloat cpSimpleMotorGetRate(const cpConstraint *constraint){ if(!(constraint->klass_private == cpSimpleMotorGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSimpleMotorGetClass()", "chipmunk/constraints/cpSimpleMotor.h", 44, 1, 1, "Constraint is not a ""cpSimpleMotor");
 return ((cpSimpleMotor *)constraint)->rate;
 } static inline void cpSimpleMotorSetRate(cpConstraint *constraint, cpFloat value){ if(!(constraint->klass_private == cpSimpleMotorGetClass())) cpMessage("constraint->CP_PRIVATE(klass) == cpSimpleMotorGetClass()", "chipmunk/constraints/cpSimpleMotor.h", 44, 1, 1, "Constraint is not a ""cpSimpleMotor");
 cpConstraintActivateBodies(constraint);
 ((cpSimpleMotor *)constraint)->rate = value;
 };
...
static inline int cpSpaceGetIterations(const cpSpace *space){return space->iterations;
} static inline void cpSpaceSetIterations(cpSpace *space, int value){space->iterations = value;
};
static inline cpVect cpSpaceGetGravity(const cpSpace *space){return space->gravity;
} static inline void cpSpaceSetGravity(cpSpace *space, cpVect value){space->gravity = value;
};
static inline cpFloat cpSpaceGetDamping(const cpSpace *space){return space->damping;
} static inline void cpSpaceSetDamping(cpSpace *space, cpFloat value){space->damping = value;
};
static inline cpFloat cpSpaceGetIdleSpeedThreshold(const cpSpace *space){return space->idleSpeedThreshold;
} static inline void cpSpaceSetIdleSpeedThreshold(cpSpace *space, cpFloat value){space->idleSpeedThreshold = value;
};
static inline cpFloat cpSpaceGetSleepTimeThreshold(const cpSpace *space){return space->sleepTimeThreshold;
} static inline void cpSpaceSetSleepTimeThreshold(cpSpace *space, cpFloat value){space->sleepTimeThreshold = value;
};
static inline cpFloat cpSpaceGetCollisionSlop(const cpSpace *space){return space->collisionSlop;
} static inline void cpSpaceSetCollisionSlop(cpSpace *space, cpFloat value){space->collisionSlop = value;
};
static inline cpFloat cpSpaceGetCollisionBias(const cpSpace *space){return space->collisionBias;
} static inline void cpSpaceSetCollisionBias(cpSpace *space, cpFloat value){space->collisionBias = value;
};
static inline cpTimestamp cpSpaceGetCollisionPersistence(const cpSpace *space){return space->collisionPersistence;
} static inline void cpSpaceSetCollisionPersistence(cpSpace *space, cpTimestamp value){space->collisionPersistence = value;
};
static inline cpBool cpSpaceGetEnableContactGraph(const cpSpace *space){return space->enableContactGraph;
} static inline void cpSpaceSetEnableContactGraph(cpSpace *space, cpBool value){space->enableContactGraph = value;
};
static inline cpDataPointer cpSpaceGetUserData(const cpSpace *space){return space->data;
} static inline void cpSpaceSetUserData(cpSpace *space, cpDataPointer value){space->data = value;
};
